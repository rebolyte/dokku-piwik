<?php
$config = json_decode(file_get_contents(dirname(__FILE__) . "/config/install_run.json"), true);
if (!is_array($config)) {
	die("[ERROR] Cannot parse JSON file at [". dirname(__FILE__) . "/config/install_run.json" ."]\n");
}
